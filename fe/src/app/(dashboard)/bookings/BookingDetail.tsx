...
export default function BookingDetail({
    ...
    const handleSaveItem = () => {
        handleAction(async () => {
            ...
            await onUpdateBookingItems(booking.id, updatedItems);
                                    ...
                                    <Box sx={{ px: 1, display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #f4f6f8' }}>
                                        ...
                                        <Stack direction="row" spacing={1}>
                                            <Button
                                                ...
                                                disabled={booking.status === BookingStatus.COMPLETED || isActionLoading}
                                                sx={{
                                                    bgcolor: "#3b82f6",
                                                    borderRadius: 0,
                                            ...
                                            >
                                                {isActionLoading ? "Loading..." : "ADD Items"}
                                            </Button>
                                        </Stack>
                                    </Box>
                                            ...
                                            <TableBody>
                                                {booking.pendingInvoiceItems?.map((item, index) => (
                                                    <TableRow
                                                        ...
                                                        sx={{
                                                            cursor: (booking.status === BookingStatus.COMPLETED || isActionLoading) ? 'default' : 'pointer',
                                                            pointerEvents: (booking.status === BookingStatus.COMPLETED || isActionLoading) ? 'none' : 'auto',
                                            ...
                                            <Stack spacing={1} sx={{ mt: 2 }}>
                                                ...
                                                >
                                                    <Typography variant="body2" sx={{ color: PRIMARY_COLOR }}>
                                                        {isActionLoading ? "Loading Discount..." : `Discount ${discountReason && `(${discountReason})`}`}
                                                    </Typography>
                                ...
                                <Paper sx={{ p: 2, borderRadius: 0 }} elevation={0}>
                                    ...
                                    <Stack spacing={1}>
                                        <Button
                                            ...
                                            onClick={() => handleAction(() => onStartService(booking.id))}
                                        ...
                                        <Button
                                            ...
                                            onClick={() => handleAction(() => onCompleteService(booking.id, { orderDiscount, discountReason }))}
                ...
                >
                    ...
                    <DialogContent dividers sx={{ p: 3 }}>
                        <Stack spacing={3}>
                            ...
                            <Paper variant="outlined" sx={{ p: 2, bgcolor: "#fafafa", borderStyle: 'dashed', borderRadius: 0 }}>
                                <Grid container spacing={2}>
                                    <Grid size={{ xs: 12 }}>
                    ...
                    <DialogActions sx={{ p: 2.5, bgcolor: "#fcfcfc" }}>
                        ...
                        <Stack direction="row" spacing={1.5}>
                            <Button onClick={() => setItemDialogOpen(false)} variant="outlined" color="inherit" sx={{ borderRadius: 0 }}>
                                Cancel
                            </Button>
                            <Button
                                variant="contained"
                                ...
                                disabled={isActionLoading || !currentItem.itemId || currentItem.quantity <= 0}
                            >
                                {isActionLoading ? (
                                    "Processing..."
                                ) : (
